/**
 * Schema is applied on every boot with `CREATE TABLE IF NOT EXISTS`, and
 * migrations are appended to MIGRATIONS as additive, idempotent statements.
 */
export const SCHEMA = `
...
/** Additive, idempotent migrations applied after the base schema. */
